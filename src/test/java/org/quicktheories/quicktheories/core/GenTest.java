...
import org.quicktheories.quicktheories.impl.ConcreteDetachedSource;
import org.quicktheories.quicktheories.impl.Constraint;
import org.quicktheories.quicktheories.impl.ExtendedRandomnessSource;
...
public class GenTest {
  ...
  public void combinesWithOtherGenUsingBiFunction() {
    ...
    Gen<Integer> combined = as.combine(bs, (a,b) -> a + b);
  ...
  public void combinesWithOtherGenUsingFunction3() {
    ...
    Gen<Integer> combined = as.combine(bs, cs, (a,b,c) -> a + b + c);
